...
# True: A boolean operator that means the value is True.
# False: A boolean operator that means the opposite of True.
# if: Used to make a conditional statement.
# elif: Checks if some other condition holds when the condition in the if statement is false.
